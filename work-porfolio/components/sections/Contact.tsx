      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            >
              <div className="relative p-4 md:p-6 rounded-xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 backdrop-blur-sm hover:border-blue-500/50 transition-all duration-500 group">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-3 md:mb-4 relative z-10 group-hover:text-blue-300 transition-colors duration-300">
                  <span className="bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent">
                    {t('contact.subtitle')}
                  </span>
                </h3>
                <p className="text-base md:text-lg text-gray-300 leading-relaxed relative z-10 group-hover:text-white transition-colors duration-300">
            ...
            {/* Contact details */}
            <div 
              className={`space-y-4 md:space-y-6 transform transition-all duration-1000 ${
                isVisible ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'
              }`}
              style={{ transitionDelay: '0.4s' }}
            >
              {/* Enhanced Email */}
              <div className="relative p-4 md:p-6 rounded-xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 backdrop-blur-sm hover:border-red-500/50 transition-all duration-500 group cursor-pointer overflow-hidden" onClick={copyEmail}>
                ...
                <div className="flex items-center relative z-10">
                  <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-red-600 to-red-700 rounded-lg flex items-center justify-center group-hover:from-red-500 group-hover:to-red-600 transition-all duration-300 shadow-lg shadow-red-500/25">
                    <SiGmail className="w-6 h-6 md:w-8 md:h-8 text-white" />
                  </div>
                  ...
                  {/* Enhanced Copy icon */}
                  <div className="absolute top-2 right-2 md:top-3 md:right-3 w-5 h-5 md:w-6 md:h-6 flex items-center justify-center bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-all duration-300">
                    <svg className="w-3 h-3 md:w-4 md:h-4 text-gray-400 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Enhanced WhatsApp */}
              <div className="relative p-4 md:p-6 rounded-xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 backdrop-blur-sm hover:border-green-500/50 transition-all duration-500 group cursor-pointer overflow-hidden" onClick={openWhatsApp}>
                {/* Animated background gradient */}
                ...
                <div className="flex items-center relative z-10">
                  <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-green-600 to-green-700 rounded-lg flex items-center justify-center group-hover:from-green-500 group-hover:to-green-600 transition-all duration-300 shadow-lg shadow-green-500/25">
                  ...
                  <div className="ml-3 md:ml-4 flex-1">
                    <p className="text-xs md:text-sm text-gray-400 group-hover:text-gray-300 transition-colors duration-300 font-medium">WhatsApp</p>
                    <p className="text-sm md:text-base text-white font-medium group-hover:text-green-300 transition-colors duration-300">+57 300 473 7692</p>
                  </div>
                </div>
                {/* Glow effect */}
              ...
              <div className="relative p-4 md:p-6 rounded-xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 backdrop-blur-sm hover:border-blue-500/50 transition-all duration-500 group overflow-hidden">
                {/* Animated background gradient */}
                ...
                <div className="flex items-center relative z-10">
                  <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg flex items-center justify-center group-hover:from-blue-500 group-hover:to-blue-600 transition-all duration-300 shadow-lg shadow-blue-500/25">
                    <SiGooglemaps className="w-6 h-6 md:w-8 md:h-8 text-white" />
                  </div>
                  <div className="ml-3 md:ml-4 flex-1">
                    <p className="text-xs md:text-sm text-gray-400 group-hover:text-gray-300 transition-colors duration-300 font-medium">Google Maps</p>
                    <p className="text-sm md:text-base text-white font-medium group-hover:text-blue-300 transition-colors duration-300">Popayán, Cauca, Colombia</p>
            ...
            <div 
              className={`flex gap-2 md:gap-4 transform transition-all duration-1000 ${
                isVisible ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'
              }`}
            ...
            >
              {socialLinks.map((link, index) => (
                <a 
                  key={link.name}
                  href={link.href} 
                  className="group/link flex items-center gap-1.5 md:gap-2 text-blue-400 hover:text-blue-300 font-medium transform transition-all duration-300 hover:scale-110 hover:-translate-y-1 relative overflow-hidden p-3 md:p-4 rounded-xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 hover:border-blue-500/50 backdrop-blur-sm"
                >
          ...
          <div 
            className={`bg-gradient-to-br from-gray-800 to-gray-900 p-4 md:p-8 rounded-xl shadow-lg border border-gray-700/50 backdrop-blur-sm transform transition-all duration-1000 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/30 hover:border-blue-500/50 relative overflow-hidden ${
              isVisible ? 'translate-x-0 opacity-100' : 'translate-x-8 opacity-0'
            }`}
          ...
          >
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <button 
                ...
                className={`group w-full px-4 py-2.5 md:px-6 md:py-3 bg-blue-600 text-white rounded-lg font-medium transition-all duration-500 transform hover:bg-blue-700 hover:shadow-2xl hover:shadow-blue-500/25 hover:scale-105 hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden text-sm md:text-base ${
